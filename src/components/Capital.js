...
const Capital = () => {
  ...
  const getRandomCapitalCity = async () => {
    ...
    const capitalOfThisCountry = randomCountry.capital[0];

    setCapitalCity(capitalOfThisCountry);
  ...
  useEffect(() => {
    (async () => {
      const trueCountryName = await getRandomCapitalCity();
  ...
  if (!loading) {
    return (
      <div className="Capital">
        ...
        <h3>{capitalCity} is the capital of</h3>
